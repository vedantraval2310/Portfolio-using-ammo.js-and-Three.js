...
Ammo().then((Ammo) => {
  ...
  //create Ammo.js body to add solid mass to "Vedant Ravval Software Engineer"
  ...
  //loads text for Vedant Raval Mesh
  function loadRyanText() {
    ...
    text_loader.load('./src/jsm/Roboto_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('Vedant Raval', {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
